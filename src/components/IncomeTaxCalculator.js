      ...
      <div className="glass-card rounded-2xl p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="flex flex-col gap-1">
            ...
            <span className="text-xs text-white/60">Hint: 10% of (Basic+DA) = {fmtR(empNPSHint)} p.a.</span>
          </div>
        </div>
      </div>
            ...
            <div className="glass-card rounded-2xl p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-xs text-white/60">Metro: Mumbai, Delhi, Kolkata, Chennai</span>
                </div>
              </div>
              {R && R.hraExemptAmt > 0 && (
        ...
        <div className="glass-card rounded-2xl p-6 border border-[#ff9f0a]/20">
          ...
          <div className="mt-6">
            ...
            <div className="space-y-1 bg-white/[0.03] rounded-xl p-4">
              ...
              {R.rebateNote && (
                <p className="text-xs text-white/60 mt-1 italic">{R.rebateNote}</p>
              )}
              <div className="flex justify-between items-center py-1 text-sm">
