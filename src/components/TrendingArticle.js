        ...
        <div className="relative rounded-xl md:rounded-2xl overflow-hidden transition-all duration-300 active:scale-[0.99]"
          ...
          <div className="flex md:hidden items-center gap-3 px-3 py-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-1.5 mb-0.5">
                ...
                <span className="text-[8px] font-black uppercase tracking-widest text-[#f5d060]">Trending</span>
              </div>
            ...
            <svg width="10" height="10" fill="none" stroke="#f5d060" strokeWidth="2.5" viewBox="0 0 24 24" className="flex-shrink-0">
          ...
          <div className="hidden md:flex items-center gap-4 px-5 py-4">
            <div className="flex-shrink-0 flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-[#f5d060] animate-pulse" />
              <span className="text-[9px] font-black uppercase tracking-widest text-[#f5d060]">Trending</span>
            </div>
            ...
            <div className="flex-shrink-0 flex items-center gap-1.5 text-[12px] font-bold text-[#f5d060]">
              വായിക്കുക
