    ...
    <div className="space-y-6">
      ...
      <div className="glass-card rounded-2xl p-6 border border-[#ff9f0a]/20">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-[900] text-white leading-tight">NPS Corpus Calculator</h1>
            <p className="text-xs text-white/60">Estimate your retirement corpus &amp; pension</p>
          </div>
        </div>
      </div>
      ...
      <div className="glass-card rounded-2xl p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            {dob
              ? <p className="text-[11px] font-bold" style={{ color: GOLD }}>Age: {currentAge} years</p>
      ...
      {/* ── Contribution & Growth ── */}
      <div className="glass-card rounded-2xl p-6">
        <SectionHeader title="Contribution & Growth" />
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <SliderRow
      ...
      <div className="glass-card rounded-2xl p-6 border border-[#ff9f0a]/20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="sm:col-span-2 p-6 rounded-2xl text-center"
            style={{ background: 'linear-gradient(135deg, rgba(255,159,10,0.15), rgba(255,159,10,0.05))', border: '1px solid rgba(255,159,10,0.3)' }}>
...
function ResultCard({ icon, label, sublabel, value, highlight }) {
  return (
    <div className="p-5 rounded-2xl"
      style={{
        background: highlight ? 'rgba(255,159,10,0.08)' : 'var(--surface-xs)',
        border: highlight ? '1px solid rgba(255,159,10,0.25)' : '1px solid var(--surface-sm)',
      }}>
      <div className="text-2xl mb-2">{icon}</div>
      <div className="text-xs text-white/50 mb-0.5">{label}</div>
      <div className="text-xs text-white/35 mb-2">{sublabel}</div>
      <div className="text-xl font-black" style={{ color: highlight ? GOLD : 'var(--text-primary)' }}>
        {value}
      </div>
    </div>
  );
