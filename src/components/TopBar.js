...
const quickPortals = [
  { label: 'SPARK', href: 'https://spark.gov.in' },
  { label: 'e-Treasury', href: 'https://treasury.kerala.gov.in' },
  { label: 'Finance Dept', href: 'https://www.finance.kerala.gov.in' },
];
...
export default function TopBar() {
  ...
  const ticker = [
    '📢 12th PRC ഉത്തരവ് — ശമ്പള പരിഷ്കരണ കാൽക്കുലേറ്റർ ലഭ്യം',
    '📋 DA Revision — July 2024 മുതൽ 35% DA പ്രഭാവത്തിൽ',
    '🏥 Medisep — 2024-25 Premium Payment Deadline Extended',
    '📌 GPF Annual Statement — March 2025 Edition Available',
  ];
  ...
  useEffect(() => {
    ...
    const t = setInterval(() => setNewsIdx(i => (i + 1) % ticker.length), 4000);
