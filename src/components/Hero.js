    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center gap-0">
        ...
        <p className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.28em] mb-2 md:mb-3"
          style={{ color: isLight ? 'rgba(30,58,95,0.60)' : 'rgba(129,212,250,0.70)' }}>
        ...
        <div className="flex flex-col items-center gap-1.5 md:gap-1.5 mb-3 md:mb-4">
          <h1 className="text-[clamp(32px,7vw,80px)] font-bold leading-[1] tracking-tight">
            <span className="bg-clip-text text-transparent" style={isLight ? {
              ...
              backgroundImage: 'linear-gradient(135deg, #4fc3f7 0%, #81d4fa 40%, #b3e5fc 55%, #81d4fa 70%, #4fc3f7 100%)',
              filter: 'drop-shadow(0 0 8px rgba(79,195,247,0.45))',
            }}>
              കേരള സർക്കാർ
            </span>
          </h1>
          ...
          <div className="w-12 h-[1.5px] rounded-full" style={{
            background: isLight
              ...
              : 'linear-gradient(90deg, transparent, rgba(79,195,247,0.8), transparent)',
          }} />
          <h2 className="text-[clamp(19px,4vw,52px)] font-bold leading-[1.15] tracking-tight">
            <span className={`bg-clip-text text-transparent bg-[length:200%_auto] ${isLight ? '' : 'animate-shimmer'}`} style={isLight ? {
              ...
              backgroundImage: 'linear-gradient(135deg, #29b6f6, #4fc3f7, #81d4fa, #4fc3f7, #29b6f6)',
        ...
        <p className="text-[clamp(11px,1.6vw,15px)] max-w-[520px] leading-relaxed font-medium px-2 mb-4 md:mb-5"
          style={{ color: isLight ? 'rgba(30,58,95,0.70)' : 'rgba(179,229,252,0.75)' }}>
          ...
          {[
            ...
            <a
              ...
              style={isLight
                ...
                : { background: 'rgba(79,195,247,0.10)', color: 'rgba(129,212,250,0.90)', border: '1px solid rgba(79,195,247,0.28)' }}
            >
              {label}
            </a>
          ))}
        ...
        >
          <span className="text-[10px] font-bold uppercase tracking-[0.25em] transition-colors" style={{ color: isLight ? 'rgba(29,78,216,0.50)' : 'rgba(129,212,250,0.55)' }}>
            Explore
          </span>
          <div className="w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 group-hover:translate-y-1" style={{ border: `1px solid ${isLight ? 'rgba(29,78,216,0.25)' : 'rgba(79,195,247,0.30)'}` }}>
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" style={{ color: isLight ? 'rgba(29,78,216,0.50)' : 'rgba(129,212,250,0.55)' }}>
              <path d="M2 4l4 4 4-4"/>
            </svg>
          </div>
        </button>
