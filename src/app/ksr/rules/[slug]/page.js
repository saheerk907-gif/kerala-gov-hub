  ...
  return (
    <>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .scheme-content ul li { padding: 0.85rem 1.1rem 0.85rem 2rem; background: ${COLOR}06; border: 1px solid ${COLOR}12; border-radius: 12px; font-size: 0.9rem; color: #aeaeb2; position: relative; font-family: var(--font-noto-malayalam), Georgia, serif; }
        ...
        .scheme-content th { background: ${COLOR}12; color: white; font-weight: 700; padding: 0.75rem 1rem; text-align: left; border: 1px solid ${COLOR}20; }
