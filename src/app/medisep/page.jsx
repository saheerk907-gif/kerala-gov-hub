...
export default async function MedisepPage() {
  ...
  return (
    <>
      ...
      <style jsx global>{`
        .scheme-content { font-family: 'Noto Sans Malayalam', Georgia, serif; line-height: 1.8; color: #e5e5e7; }
        .scheme-content h3 { font-size: 1.1rem; font-weight: 700; color: #ff9f0a; margin: 2rem 0 0.75rem; display: flex; align-items: center; gap: 0.5rem; }
        .scheme-content h3::before { content: ''; display: inline-block; width: 4px; height: 1em; background: #ff9f0a; border-radius: 2px; flex-shrink: 0; }
        ...
        .scheme-content ul li { padding: 0.85rem 1.1rem; background: rgba(255,159,10,0.04); border: 1px solid rgba(255,159,10,0.12); border-radius: 12px; font-size: 0.9rem; color: #aeaeb2; display: flex; align-items: flex-start; gap: 0.75rem; }
        .scheme-content ul li::before { content: '✦'; color: #ff9f0a; font-size: 0.6rem; margin-top: 0.35rem; flex-shrink: 0; }
      `}</style>
